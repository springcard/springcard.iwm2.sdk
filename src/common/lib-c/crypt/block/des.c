 ...
 * main fact is that is compiles (and works !) on inexpensive MCUs (less than
 * 5k on Renesas R8C) as well as on 32bits CPUs.
 *
 * This code has been written from scratch, but with libgcrypt DES 
 * implementation as template (http://freshmeat.net/projects/libgcrypt/)
 */
