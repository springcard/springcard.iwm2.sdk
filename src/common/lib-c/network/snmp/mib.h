...
struct	mib_tcp {
    ...
    u_long  tcpInErrs;	        /* number of segments received in error*/
    u_long  tcpOutRsts;	        /* number of segments sent containing the RST flag */
};   
...
extern void init_mib _ANSI_ARGS_((void));

extern void print_variable _ANSI_ARGS_((oid *objid, 
				int objidlen, 
				struct variable_list *variable));

extern char *snmp_new_prefix _ANSI_ARGS_((char *prefix));

extern void sprint_objid _ANSI_ARGS_((char *buf, oid *objid, int objidlen));

extern void sprint_variable _ANSI_ARGS_((char *buf, oid *objid, int objidlen,
					 struct variable_list *variable));

extern void initmib _ANSI_ARGS_((char *options));
